      ...
      <Router>
        <header className='header'>
          <div className='header-logo'>
            <img className='logo__img' src={logoBBG} alt="" srcSet="" />
          ...
          <div className='header-auth-buttons'>
            ...
            <button className='header-auth-buttons__login auth__button'>Log In</button>
            <button className='header-auth-buttons__signup auth__button auth__button--active'>Sign Up</button>
          </div>
        </header>
